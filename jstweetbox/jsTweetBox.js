var jsTweetBox = function(){
  ...
  initAnywhere = function(T){
   $T = T;	
   $twtBox = $("#js-tweet-box");	
	$twtBox.append("<div class='js-sidebar'></div><div class='js-reactions'>React on Twitter...<textarea name='js-tweet-box' rows='4' cols='50'></textarea>"
  ...
  processRecentTweets = function(json){
	if (json.array.length > 0) {
   	...
   	for(var i = json.array.length - 1; i >= 0; i--) {
   		curStatus = json.array[i];
...
//		tweetBox.setReply(replyID, userReply);
  ...
  addFollowMe = function(user){
	$pub = user;
//<div class="js-publisher" title="Thanks for Following JSBlogStop">JSBlogStop<br>
//	 	<img class="js-publisher-img" src="http://a2.twimg.com/profile_images/1220787953/iconsetc-blogger_normal.png">
//	 	<div class="button" style="margin: 5px auto;">Unfollow</div>
//	 </div>
  ...
  $("head").append("<link id='js-tweet-box-styles' rel='stylesheet' type='text/css' href='http://jsblogstop.googlecode.com/svn/jstweetbox/jsTweetBox.css'/>");
  $(document).ready(init);
  return this;
}();