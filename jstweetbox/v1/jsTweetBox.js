...
//		tweetBox.setReply(replyID, userReply);
  ...
  $("head").append("<link id='js-tweet-box-styles' rel='stylesheet' type='text/css' href='https://cdn.rawgit.com/hamzahjamad/jsblogstop/master/jstweetbox/v1/jsTweetBox.css'/>");
  $(document).ready(init);
  return this;
}();